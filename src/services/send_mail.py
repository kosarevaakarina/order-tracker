...
class EmailService:
    ...
    async def notify_order_status_update(self, to_email: str, order_data: dict, previous_status: str):
    ...
    async def notify_order_creation(self, to_email: str, order_id: int):
